...
//                   $scope.deleteApp = function(appId,item){
//                   var confirmPopup = $ionicPopup.confirm({
//                                                          title: 'Car Dealers Delete!',
//                                                          template: 'Are you sure you want to delete this Car Dealers?'
//                                                          });
//                   confirmPopup.then(function(res) {
//                                     if(res) {
//                                     $ionicLoading.show({
...
//                                       image = undefined;
                   ...
                   navigator.notification.alert("Select Car Dealers Image & Enter Car Dealers Title");
                   }
                   }
...
control.controller('addContentCtrl',function($scope,$state,$ionicPopup,$sce,$ionicLoading,$ionicScrollDelegate,$http,$ionicModal,$ionicActionSheet){
                   ...
                   navigator.notification.alert('Please Enter Your Content Title!',alertDismissed,'Car Dealers','done');
                   }
...
//                                image = undefined;
                   ...
                   $.ajax({
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error12331: "+error.responseText);
                                 }
                                 });
                          $.ajax({
                                 type: methodData,
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error12232: "+error.responseText);
                                 }
                                 });
                          $.ajax({
                                 type: methodData,
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error3: "+error.responseText);
                                 }
                                 });
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error4: "+error.responseText);
                                 }
                                 });
                          $.ajax({
                                 type: methodData,
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error5: "+error.responseText);
                                 }
                                 });
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error6: "+error.responseText);
                                 }
                                 });
                          ...
                          error:function(error,status){
                          $ionicLoading.hide();
                          navigator.notification.alert("error7: "+error.responseText);
                          }
                          });
                   };
                   ...
                   $.ajax({
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 navigator.notification.alert("error8: "+error.responseText);
                                 }
                                 });
                          }
                          $.ajax({
